...
import xyz.cybernerd404.cryptox.view.coins.coinDetail.CoinDetailViewModel
...
class ViewModelFactory(
    ...
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        return when{
            ...
            modelClass.isAssignableFrom(CoinDetailViewModel::class.java) -> CoinDetailViewModel(repository as CoinDetailRepository) as T
